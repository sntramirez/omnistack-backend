...
from (
select '1' as chain, '148' as store, 'FYBECA AMAZONAS' as store_name, '1' as pos, 'POS' as channel_pos, '1' as category_code, 'GENERICO' as category_name, '1' as subcategory_code, 'GENERICO' as subcategory_name, 1 as is_active from dual
union all

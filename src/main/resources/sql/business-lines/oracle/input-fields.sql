...
union all
select '1' as chain, '148' as store, 'FYBECA AMAZONAS' as store_name, '1' as pos, 'POS' as channel_pos, '1' as category_code, '1' as subcategory_code, '2' as service_provider_code, '100708848' as rms_item_code, 'document' as input_field_id, 'Documento Usuario' as label, 'STRING' as field_type, 'PRECHECK' as capability_code, 1 as is_required, 'IDENTIFICATION' as field_group, '' as conditional_operator from dual
union all
select '1' as chain, '148' as store, 'FYBECA AMAZONAS' as store_name, '1' as pos, 'POS' as channel_pos, '1' as category_code, '1' as subcategory_code, '2' as service_provider_code, '100708848' as rms_item_code, 'withdrawId' as input_field_id, 'Numero asignado a retiro' as label, 'STRING' as field_type, 'PRECHECK' as capability_code, 1 as is_required, 'ID' as field_group, '' as conditional_operator from dual
union all

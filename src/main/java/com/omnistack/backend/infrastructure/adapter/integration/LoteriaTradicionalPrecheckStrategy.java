                ...
                draws = list.stream()
                        ...
                        .map(s -> {
                            ...
                            return PrecheckResponse.TradicionalDraw.builder()
                                    .drawId(sorteo.getSorteoId())
                                    .juegoId(sorteo.getJuegoId()).nombreJuego(sorteo.getNombreJuego())
                                    .nombre(sorteo.getNombre()).nombreSalaSorteo(sorteo.getNombreSalaSorteo())
                                    .clase(sorteo.getClase())
                                    .fecha(sorteo.getFecha()).fechaCierreVentas(sorteo.getFechaCierreVentas())
                                    .fechaCaducidadSorteo(sorteo.getFechaCaducidadSorteo())
                                    .precio(sorteo.getPrecio())
                                    .premioMayor(sorteo.getPremioMayor())
                                    .seAcumula(sorteo.getSeAcumula()).montoProximoSorteo(sorteo.getMontoProximoSorteo())
                                    .esSorteoDestacado(sorteo.getEsSorteoDestacado())
                                    .cantidadFraccion(sorteo.getCantidadFraccion())
                                    .nombreNumero(sorteo.getNombreNumero())
                                    .cantidadDigitosCombinacionPrincipal(sorteo.getCantidadDigitosCombinacionPrincipal())
                                    .cantidadDigitosCombinacionSecundaria(sorteo.getCantidadDigitosCombinacionSecundaria())
                                    .nombreSegundaCombinacion(sorteo.getNombreSegundaCombinacion())
                                    .nombreTerceraCombinacion(sorteo.getNombreTerceraCombinacion())
                                    .nombreCuartaCombinacion(sorteo.getNombreCuartaCombinacion())
                                    .nombreQuintaCombinacion(sorteo.getNombreQuintaCombinacion())
                                    .tienePremioInstantaneo(sorteo.getTienePremioInstantaneo())
                                    .tipoPremioPrimeraSuerte(sorteo.getTipoPremioPrimeraSuerte())
                                    .nombrePrimeraSuerte(sorteo.getNombrePrimeraSuerte())

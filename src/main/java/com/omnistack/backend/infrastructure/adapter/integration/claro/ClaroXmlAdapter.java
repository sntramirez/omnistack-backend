...
public class ClaroXmlAdapter implements ClaroPrecheckPort, ClaroExecutePort {
    ...
    private String buildPrecheckXml(
        ...
        return "<umsprot version=\"1\">"
                ...
                + field("validateRechargeRetail", "CODCAJA", command.getPos())
                + field("validateRechargeRetail", "CODSITE", command.getStore())
    ...
    private String buildExecuteXml(
        ...
        return "<umsprot version=\"1\">"
                ...
                + field("processRechargeRetail", "PV_CHANNELID", command.getChannelId())
                ...
                + field("processRechargeRetail", "CODCAJA", command.getPos())
                + field("processRechargeRetail", "CODSITE", command.getStore())
